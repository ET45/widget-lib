...
public final class WidgetLayoutMediumBinding implements ViewBinding {
  @NonNull
  ...
  private WidgetLayoutMediumBinding(@NonNull LinearLayout rootView, @NonNull TextView highestText,
      @NonNull ImageView light, @NonNull TextView lowestHour, @NonNull TextView lowestText,
      @NonNull TextView priceMin, @NonNull TextView priceToday, @NonNull TextView timeRange,
      @NonNull TextView title, @NonNull TextView unitHigh, @NonNull TextView unitLow,
  ...
  @NonNull
  public static WidgetLayoutMediumBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static WidgetLayoutMediumBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.widget_layout_medium, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static WidgetLayoutMediumBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new WidgetLayoutMediumBinding((LinearLayout) rootView, highestText, light, lowestHour,
          lowestText, priceMin, priceToday, timeRange, title, unitHigh, unitLow, widgetRoot);
    }
