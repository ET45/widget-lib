...
public final class WidgetLayoutSmallBinding implements ViewBinding {
  ...
  private WidgetLayoutSmallBinding(@NonNull LinearLayout rootView, @NonNull TextView highestText,
      @NonNull ImageView light, @NonNull TextView lowestHour, @NonNull TextView lowestText,
      @NonNull TextView priceMin, @NonNull TextView priceToday, @NonNull TextView title,
      @NonNull TextView unitHigh, @NonNull TextView unitLow, @NonNull LinearLayout widgetRoot) {
  ...
  public static WidgetLayoutSmallBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new WidgetLayoutSmallBinding((LinearLayout) rootView, highestText, light, lowestHour,
          lowestText, priceMin, priceToday, title, unitHigh, unitLow, widgetRoot);
    }
